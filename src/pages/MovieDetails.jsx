...
import { genreId , genreId_to_key} from "../srcn/data/data";

const MovieDetails = ({homeMode, setHomeMode, genreID, setGenreID }) => {
          ...
          <div className="float-left w-[70%] md:pl-12 ">
            ...
            <div className="flex flex-row items-center ">
              ...
              <div className="flex flex-col">
                ...
                <div className="grid grid-flow-col auto-cols-max gap-4 mb-3" onClick={() => {setHomeMode(false);navigate("/genre");}}>
                  {movieData.genres &&
                    movieData.genres.slice(0, 5).map((genre, i) => (
                      <button key={i} className="text-sm  md:text-base hover:text-cyan-600" onClick={() => {setGenreID(genreId_to_key(genre.id));}} >
                        {genre.name}
                      </button>
                    ))}
                </div>
